...
<script src="{% static '/path/to/jquery.easy-pie-chart.js' %}"></script>
<script>
    $(function() {
        $('.chart').easyPieChart({
...
<script src="{% static '/path/to/easy-pie-chart.js' %}"></script>
<script>
...
<script src="{% static 'https://ajax.googleapis.com/ajax/libs/angularjs/1.2.9/angular.min.js' %}"></script>
<script src="{% static '../dist/angular.easypiechart.min.js' %}"></script>
<script>
